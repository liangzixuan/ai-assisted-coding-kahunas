                  ...
                  >
                    ...
                    {!isCollapsed && (
                      <>
                        ...
                        {item.badge && (
                          <span className="ml-auto inline-flex items-center justify-center px-2 py-1 text-xs font-medium bg-yellow-100 text-yellow-800 dark:bg-yellow-900/20 dark:text-yellow-400 rounded-full">
                            {item.badge}
                          </span>
                        )}
                      </>
                    ...
                    {isCollapsed && item.badge && (
                      <span className="absolute left-8 top-2 w-2 h-2 bg-yellow-500 rounded-full"></span>
                    )}
                  </Link>
                </li>
              );
